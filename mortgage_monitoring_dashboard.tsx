...
import { LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ResponsiveContainer, BarChart, Bar, ScatterPlot, Scatter, Area, AreaChart, PieChart, Pie, Cell } from 'recharts';
import { AlertTriangle, TrendingUp, TrendingDown, Activity, Eye, Database, Clock, CheckCircle, XCircle, AlertCircle } from 'lucide-react';

const MortgageModelMonitoringDashboard = () => {
  ...
  const currentMetrics = dashboardData.modelPerformance[dashboardData.modelPerformance.length - 1];
  const previousMetrics = dashboardData.modelPerformance[dashboardData.modelPerformance.length - 2];
      ...
      <div className="max-w-7xl mx-auto">
          ...
          {[
            ...
            <div key={index} className="bg-white rounded-lg shadow-sm border p-6">
              ...
              <div className={`flex items-center mt-4 text-sm ${
                metric.trend.trend === 'up' ? 'text-green-600' : 'text-red-600'
              }`}>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6 mb-8">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={dashboardData.modelPerformance}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="date" />
              <YAxis domain={['dataMin - 0.01', 'dataMax + 0.01']} />
              <Tooltip formatter={(value) => [(value * 100).toFixed(1) + '%', selectedMetric.toUpperCase()]} />
              <Legend />
              <Line 
                type="monotone" 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <div className="space-y-4">
              {dashboardData.dataDrift.map((feature, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <div className="text-right">
                    ...
                    <p className={`text-sm ${
                      feature.drift > 0.05 ? 'text-red-600' : 
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <BarChart data={dashboardData.predictionDistribution}>
                ...
                <XAxis dataKey="range" />
                <YAxis />
                <Tooltip formatter={(value, name) => [value.toLocaleString(), 'Predictions']} />
          ...
          <div className="bg-white rounded-lg shadow-sm border p-6">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <LineChart data={dashboardData.businessMetrics}>
                ...
                <Tooltip />
                <Legend />
                <Line yAxisId="left" type="monotone" dataKey="avgProcessingTime" stroke="#8884d8" name="Avg Processing Time (ms)" />
                <Line yAxisId="right" type="monotone" dataKey="throughput" stroke="#82ca9d" name="Throughput (req/min)" />
              </LineChart>
            </ResponsiveContainer>
          </div>
...
export default MortgageModelMonitoringDashboard;